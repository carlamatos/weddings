...
const securityHeaders = [
  {
    ...
    value: [
      ...
      "media-src 'self'",
      "connect-src 'self' https://maps.googleapis.com https://accounts.google.com https://www.google-analytics.com https://analytics.google.com https://region1.google-analytics.com",
